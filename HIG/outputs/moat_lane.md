...
*Generated: 2026-09-01 09:20 | Price: $137.38 | Mkt Cap: $37B*
...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 8.0/10 | 30% | 2.4 | ROE: 22.1% (financials — book-return proxy); Earnings: 3/3 up-years (monotonic); 5y price drawdown: 0% (stable); FCF/NI: n/a for financials (float/deposit accounting); Gross margin: n/a for financials | - |
...
| Valuation Fit | 10.0/10 | 20% | 2.0 | P/E 10.0x — deep value; 52w range position: 66%; Owner earnings yield: 14.8% (>5%) | - |
...
- **Margin of Safety**: 161% — PRESENT (IV $359 vs $137 at 25x)
