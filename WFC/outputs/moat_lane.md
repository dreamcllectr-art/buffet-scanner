...
*Generated: 2026-08-06 06:42 | Price: $89.17 | Mkt Cap: $270B*
...
|--------|-------|--------|----------|-----------|----------------|
| Quality | 6.6/10 | 30% | 2.0 | ROE: 12.6% (financials — book-return proxy); Earnings: 3/3 up-years (monotonic); 5y price drawdown: 0% (stable); FCF/NI: n/a for financials (float/deposit accounting); Gross margin: n/a for financials | - |
...
| Valuation Fit | 10.0/10 | 20% | 2.0 | P/E 11.3x — deep value; 52w range position: 66% | - |
...
- **Margin of Safety**: 95% — PRESENT (IV $174 vs $89 at 25x)
